...
return( <div>
    ...
    <form className="mt-3" onSubmit={submitHandler}>
        <input name="mobile_number" className='col-4 mb-3 ml-3'  value={mobile_number} onChange={(e)=>{setMobile_Number(e.target.value)}} placeholder="Enter a customer's phone number"></input>
